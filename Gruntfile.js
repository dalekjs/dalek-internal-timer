...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    documantix: {
      options: {
        ...
        target: 'report/docs',
        vars: {
          title: 'DalekJS - Documentation - Timer',
          desc: 'DalekJS - Documentation - Timer',
          docs: true
        }
      },
      src: ['index.js']
  ...
  grunt.registerTask('archive', function () {
    ...
    grunt.util.spawn({cmd: 'git', args: ['describe', '--abbrev=0', '--tags']}, function (error, result) {
      ...
      if (grunt.file.isFile('_raw/docs/' + lastTag + '/timer.html')) {
      ...
      grunt.file.copy('report/docs/timer.html', '_raw/docs/' + lastTag + '/timer.html');
